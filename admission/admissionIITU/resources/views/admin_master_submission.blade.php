        ...
        <div class="container" style="margin-top: 100px;">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('admin_master_submission_create_url') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label>Prerequisites</label>
                                    <input type="file" class="form-control" name="prerequisites">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Tuition</label>
                                    <input type="file" class="form-control" name="tuition">
                                </div>
                                <div class="form-group">
                                    <label>Double Diploma</label>
            ...
            <table class="table table-fhr">
                ...
                <tr>
                    ...
                    <th scope="col">Double diploma</th>
                ...
                @foreach($master as $mes)
                    <tr class="unread checked">
                        ...
                        <td class="hidden-xs">
                            <a href="{{ asset('uploads/master/' . $mes->prerequisites) }}">{{$mes->prerequisites}}</a>
                        </td>
                        <td class="hidden-xs">
                            {{ $mes->submission }}
                        </td>
                        <td class="hidden-xs">
                            <a href="{{ asset('uploads/master/' . $mes->tuition) }}">{{$mes->tuition}}</a>
                        </td>
                        <td class="hidden-xs">
                            <a href="{{ asset('uploads/master/' . $mes->diploma) }}">{{$mes->diploma}}</a>
                        </td>
                        <td>
                            <a href="{{route('admin_master_submission_edit_url', $mes->id)}}">
                        ...
                        <td>
                            <form action="{{route('admin_master_submission_delete_url', $mes->id)}}" method="post">
                                @csrf
                                @method('delete')
