    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li><a href="forms.html"><i class="lnr lnr-spell-check"></i> <span>Programs</span></a></li>
                <li><a href="{{ route('admin_reception_create_url') }}"><i class="lnr lnr-menu"></i> <span>Receptions</span></a></li>
            ...
            <table class="table table-fhr">
                ...
                @foreach($programs as $mes)
                    <tr class="unread checked">
                        ...
                        <td>
                            <form action="{{route('admin_reception_delete_url', $mes->id)}}" method="post">
                                @csrf
                                @method('delete')
