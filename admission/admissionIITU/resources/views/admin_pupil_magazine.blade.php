                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('admin_pupil_magazine_create_url') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
            ...
            <table class="table table-fhr">
                ...
                @foreach($pupil as $mes)
                    <tr class="unread checked">
                        ...
                        <td>
                            <form action="{{route('admin_pupil_magazine_delete_url', $mes->id)}}" method="post">
                                @csrf
                                @method('delete')
