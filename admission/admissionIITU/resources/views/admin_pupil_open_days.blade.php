                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('admin_pupil_open_days_create_url') }}">
                                {{ csrf_field() }}
            ...
            <table class="table table-fhr">
                ...
                @foreach($pupil as $mes)
                    <tr class="unread checked">
                        ...
                        <td>
                            <a href="{{route('admin_pupil_open_days_edit_url', $mes->id)}}">
                        ...
                        <td>
                            <form action="{{route('admin_pupil_open_days_delete_url', $mes->id)}}" method="post">
                                @csrf
                                @method('delete')
