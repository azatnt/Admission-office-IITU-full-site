    ...
    <div class="main-content">
        ...
        <div class="container" style="margin-top: 90px;">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('admin_pupil_update_url', $pupil->id)}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                    {{--        <input type="hidden" name="_method" value="PUT" />--}}
                    <div class="form-group">
                        <label>Admissions of regulations</label>
                        <input type="text" class="form-control" name="admission" value="{{ $pupil->admission_regulations }}">
                    </div>
                    <div class="form-group">
                        <label> Submissions of documents</label>
                        <input type="text" class="form-control" name="submission" value="{{ $pupil->submission_documents }}">

                    </div>
                    <div class="form-group">
                        <label> Olympiad of IITU</label>
                        <input type="text" class="form-control" name="olympiad" value="{{ $pupil->olympiad }}">

                    </div>
                    <div class="input-group">
                        <label for="">Guidebook of applicant</label>
                        <div class="custom-file">
                            <input type="file" name="guidebook" class="custom-file-input" value="{{ $pupil->guidebook }}">
                    ...
                    <div class="input-group">
                        ...
                        <div class="custom-file">
                            <input type="file" name="tuition_fee" class="custom-file-input" value="{{ $pupil->tuition_fee }}">
                            <label class="custom-file-label">Choose file</label>
                        </div>
                    </div>
