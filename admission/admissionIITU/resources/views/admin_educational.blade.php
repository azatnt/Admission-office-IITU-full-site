                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('admin_bachelor_educational_create_url') }}">
                                {{ csrf_field() }}
            ...
            <table class="table table-fhr">
                ...
                @foreach($data as $mes)
                    <tr class="unread checked">
                        ...
                        <td>
                            <a href="{{route('admin_bachelor_educational_edit_url', $mes->id)}}">
                        ...
                        <td>
                            <form action="{{route('admin_bachelor_educational_delete_url', $mes->id)}}" method="post">
                                @csrf
                                @method('delete')
