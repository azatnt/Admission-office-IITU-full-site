    ...
    <div class="main-content">
        ...
        <div class="container" style="margin-top: 90px;">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('admin_pupil_open_day_update_url', $pupil->id)}}">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                    {{--        <input type="hidden" name="_method" value="PUT" />--}}
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" class="form-control" name="title" value="{{$pupil->title}}">
                    </div>
                    <div class="form-group">
                        <label> Description</label>
                        <input type="text" class="form-control" name="description" value="{{$pupil->description}}">

                    </div>
                    <div class="form-group">
                        <label>Date</label>
                        <input type="text" class="form-control" name="date" value="{{$pupil->date}}">
                    </div>
