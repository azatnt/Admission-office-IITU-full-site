    ...
    <div class="main-content">
        ...
        <div class="container" style="margin-top: 90px;">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('admin_master_submission_update_url', $data->id)}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                    <div class="form-group">
                        <label>Prerequisites</label>
                        <input type="file" class="form-control" name="prerequisites" value="{{$data->prerequisites}}">
                    </div>

                    <div class="form-group">
                        <label>Submission</label>
                        <input type="text" class="form-control" name="submission" value="{{$data->submission}}">
                    </div>
                    <div class="form-group">
                        <label>Tuition</label>
                        <input type="file" class="form-control" name="tuition" value="{{$data->tuition}}">
                    </div>
                    <div class="form-group">
                        <label>Double Diploma</label>
                        <input type="file" class="form-control" name="diploma" value="{{$data->diploma}}">
                    </div>
