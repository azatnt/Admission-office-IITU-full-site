                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Add pupils</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">
                            <form method="post" action="{{ route('admin_pupil_create_url') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label>Admissions of regulations</label>
                                    <input type="text" class="form-control" name="admission">
                                </div>
                                <div class="form-group">
                                    <label> Submissions of documents</label>
                                    <input type="text" class="form-control" name="submission">

                                </div>
                                <div class="form-group">
                                    <label> Olympiad of IITU</label>
                                    <input type="text" class="form-control" name="olympiad">

                                </div>
                                <div class="input-group">
                                    <label for="">Guidebook of applicant</label>
                                    <div class="custom-file">
                                        <input type="file" name="guidebook" class="custom-file-input">
                                        <label class="custom-file-label">Choose file</label>
                                    </div>
                                </div>
                                <div class="input-group">
                                    <label for="">Tuition of fee</label>
                                    <div class="custom-file">
                                        <input type="file" name="tuition_fee" class="custom-file-input">
                                        <label class="custom-file-label">Choose file</label>
                                    </div>
                                </div>
            ...
            <table class="table table-fhr">
                ...
                @foreach($pupil as $mes)
                    <tr class="unread checked">
                        ...
                        <td>{!! Str::limit($mes->admission_regulations, 190, ' ...') !!}</td>
                        <td>
                            {!! Str::limit($mes->submission_documents, 190, ' ...') !!}
                        </td>
                        <td>
                            {!! Str::limit($mes->olympiad, 190, ' ...') !!}
                        </td>
                        <td>
                                                        <a href="{{ asset('uploads/pupils/' . $mes->guidebook) }}">open</a>
{{--                            <img style="height: 5%" src="{{ asset('uploads/programs/' . $mes->image) }}" alt="image">--}}
                        </td>
                        <td>
                            <a href="{{ asset('uploads/pupils/' . $mes->tuition_fee) }}">open</a>
                            {{--                            <img style="height: 5%" src="{{ asset('uploads/programs/' . $mes->image) }}" alt="image">--}}
                        </td>
                        <td>
                        ...
                        <td>
                            <form action="{{route('admin_pupil_delete_url', $mes->id)}}" method="post">
                                @csrf
                                @method('delete')
